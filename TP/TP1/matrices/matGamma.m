...
%% matGamma     matrice Gamma de differentiation d'ordre 1 ou 2
%       G = matGamma(SIZE,TYPE)     cree la matrice de taille SIZE de   
%       derivation de type TYPE
%       . SIZE = size(x) avec x le signal d'origine ou l'image d'origine
%         non vectorisee
...
%       figure(1); clf;
%       plot(t,s,'-',t,s_grad,'--');
%       legend('signal original','signal derive');
% 
% 
%     Ex 2 (2D):
